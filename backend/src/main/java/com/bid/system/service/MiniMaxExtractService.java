...
public class MiniMaxExtractService {
    ...
    public String extractRawText(File file) throws Exception {
    ...
    public Map<String, Object> extractFromSavedFile(File file) throws Exception {
        return extractFromImages(Files.readAllBytes(file.toPath()));
    }
}
